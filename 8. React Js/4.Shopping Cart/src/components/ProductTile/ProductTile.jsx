...
const ProductTile = ({ singleProductTile }) => {
  ...
  const handleNaviateToProductDetailsPage = (getCurrentProductID) => {
  ...
  return (
    <div className="relative group border border-cyan-700 p-6 cursor-pointer ">
      ...
      <button
        onClick={() => handleNaviateToProductDetailsPage(singleProductTile?.id)}
